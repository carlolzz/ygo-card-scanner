...
void main() {
  group('phashFromBlock exactness (Tier 1)', () {
    ...
    for (final sample in samples) {
      ...
      test('matches imagehash exactly for $passcode', () {
        ...
        final actual = phashFromBlock(Uint8List.fromList(pixels));
  ...
  group('phashFromBlock basic properties', () {
